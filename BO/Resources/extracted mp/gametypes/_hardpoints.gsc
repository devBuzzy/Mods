...
if( level.killstreakRoundDelay >= (maps\mp\gametypes\_globallogic_utils::getTimePassed() / 1000) && isDelayableKillstreak(killstreakType) &&
!maps\mp\gametypes\_killstreak_weapons::isHeldKillstreakWeapon(killstreakType) )
{
