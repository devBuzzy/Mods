...
continue;
if ( isDefined( level.perkReferenceToIndex[ perk ] ) &&
level.perkReferenceToIndex[ perk ] )
{
self maps\mp\gametypes\_globallogic_score::incItemStatByIndex( level.perkReferenceToIndex[ perk ], totalTime, "timeUsed" );
}
}
}
}
