...
for ( i = 0; i < self.objectArray.size; i++ )
{
if ( isdefined(self.objectArray[i]) && ( !self.objectArray[i] isstunned() || forceDetonation ) )
{
if ( IsDefined( weapon ) )
{
...
self.hackerTrigger SetCursorHint( "HINT_NOICON" );
...
self.hatchetPickUpTrigger SetCursorHint( "HINT_NOICON" );
if( IsDefined(level.retrieveHints[watcher.name]) )
{
