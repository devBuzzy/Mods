...
create_napalm_fire_influencers( point, parent_team, duration )
{
timeout = duration;
weapon_team_mask = 0;
AddSphereInfluencer( level.spawnsystem.eINFLUENCER_TYPE_NORMAL,
...
ss.napalm_influencer_score_curve =	set_dvar_if_unset("scr_spawn_napalm_influencer_score_curve", "steep");
ss.napalm_influencer_radius =	set_dvar_float_if_unset("scr_spawn_napalm_influencer_radius", "" + 3500);
