...
if ( true /*is game over? or is cargo safe zone time up?*/ )
{
if ( isDefined( player ) && isDefined( player.name ) )
...
if ( ( !isdefined( sWeapon ) || !maps\mp\gametypes\_hardpoints::isKillstreakWeapon( sWeapon ) ) && medalGiven == false )
{
