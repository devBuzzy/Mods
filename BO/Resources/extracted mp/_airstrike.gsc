...
losRadiusDamage( bombPoint + (0,0,16), 896, 300, 50, owner, self, "airstrike_mp", breakGlass );
}
...
losRadiusDamage(pos, radius, max, min, owner, eInflictor, sWeapon, breakGlass)
{
...
not_black = ( 1, 0.2, 0.2 );
debugstar(pos + (0, 0, 100), 20 * 100, not_black);
