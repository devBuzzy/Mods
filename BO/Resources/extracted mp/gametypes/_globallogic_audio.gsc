...
if( randomintrange( 0, 20 ) < 15 && player.pers["music"].currentState != "ACTION" && player.pers["music"].currentState != "TIME_OUT" && player.pers["music"].currentState != "UNDERSCORE")
{
